# Generated by Django 4.1.3 on 2023-07-15 05:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('calificacion', models.CharField(choices=[('en revision', 'en revision'), ('aprobado', 'Aprobado'), ('No aprobado', 'No aprobado')], default='en revision', max_length=20)),
